...
#define APP_USB_UAC_USE_SPEAKER    1
...
#define APP_USB_UAC_SPK_IF_NUM      0x01
#define APP_USB_UAC_MIC_IF_NUM      0x02
...
#define APP_USB_UAC_SPK_IF_NUM      0x01
#define APP_USB_UAC_MIC_IF_NUM      0x01
#elif (!APP_USB_UAC_USE_SPEAKER && APP_USB_UAC_USE_MICROPHONE)
#define APP_USB_UAC_DESCR_TOTAL_LEN 0x6E
#define APP_USB_UAC_INTERFACE_NUMS  2
#define APP_USB_UAC_AC_HEADER_LEN   0x09
...
const uint8_t uac_cfg_descr[] = {
    ...
    0x09,                    // bLength
    0x04,                    // bDescriptorType (Interface)
    APP_USB_UAC_SPK_IF_NUM,  // bInterfaceNumber (Audio Streaming Interface)
    ...
    0x09,                    // bLength
    0x04,                    // bDescriptorType (Interface)
    APP_USB_UAC_SPK_IF_NUM,  // bInterfaceNumber
    ...
    0x09,                    // bLength
    0x04,                    // bDescriptorType (Interface)
    APP_USB_UAC_MIC_IF_NUM,  // bInterfaceNumber (Audio Streaming Interface)
    0x00,                    // bAlternateSetting (Alternate Setting 0)
    0x00,                    // bNumEndpoints (No endpoints in this setting)
    0x01,                    // bInterfaceClass (Audio)
    0x02,                    // bInterfaceSubClass (Audio Streaming)
    ...
    0x09,                    // bLength
    0x04,                    // bDescriptorType (Interface)
    APP_USB_UAC_MIC_IF_NUM,  // bInterfaceNumber
    0x01,                    // bAlternateSetting (Alternate Setting 1)
    0x01,                    // bNumEndpoints (1 endpoint)
    0x01,                    // bInterfaceClass (Audio)
    0x02,                    // bInterfaceSubClass (Audio Streaming)
